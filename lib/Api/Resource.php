...
class Resource
{
    private static $requestCreator = null;
    ...
    public static function setRequestCreator(RequestCreatorInterface $requestCreator)
    {
        self::$requestCreator = $requestCreator;
    }

    protected function createRequest($method, $url, $headers, $httpBody)
    {
        return self::$requestCreator->createRequest(
            $method,
            $url,
            $headers,
            $httpBody
