 ...
 * @author   Fozzy Inc.
 */
class TemplateDefinition implements ModelInterface, ArrayAccess
{
...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param int $id Template primary ID. Used on machine creation
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Template name includes OS version
     *
     * @return $this
     */
