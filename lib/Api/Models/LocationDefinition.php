...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param int $id Location primary ID. Used on machine creation
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Location name. Can includes country, city, data center name, etc.
     *
     * @return $this
     */
