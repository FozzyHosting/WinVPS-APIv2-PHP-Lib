...
/**
 * MachineAdditionsDefinition Model
 *
 * @category Class
 * @description Additional resources which needed for machine over the product limits.
 * @package  Fozzy\WinVPS\Api
 * @author   Fozzy Inc.
 */
class MachineAdditionsDefinition implements ModelInterface, ArrayAccess
{
...
* @var string
*/
protected static $swaggerModelName = 'MachineAdditionsDefinition';
