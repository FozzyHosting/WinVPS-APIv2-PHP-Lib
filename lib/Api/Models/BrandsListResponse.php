...
/**
 * BrandsListResponse Model
 *
 * @category Class
 * @package  Fozzy\WinVPS\Api
 * @author   Fozzy Inc.
 */
class BrandsListResponse implements ModelInterface, ArrayAccess
{
...
* @var string
*/
protected static $swaggerModelName = 'BrandsListResponse';
...
'data' => '\Fozzy\WinVPS\Api\Models\BrandsList',
...
return count($this->listInvalidProperties()) === 0;
    ...
    * Gets data
    *
    * @return \Fozzy\WinVPS\Api\Models\BrandsList
    */
    ...
    * Sets data
    *
    * @param \Fozzy\WinVPS\Api\Models\BrandsList $data data
    *
    * @return $this
    */
