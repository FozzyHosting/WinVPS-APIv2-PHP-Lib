...
/**
 * MachineReinstallRequestBody Model
 *
 * @category Class
 * @package  Fozzy\WinVPS\Api
 * @author   Fozzy Inc.
 */
class MachineReinstallRequestBody extends MachineReinstallableFields 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MachineReinstallRequestBody';
