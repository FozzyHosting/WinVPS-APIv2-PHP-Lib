...
/**
 * MachineDetailsResponse Model
 *
 * @category Class
 * @package  Fozzy\WinVPS\Api
 * @author   Fozzy Inc.
 */
class MachineDetailsResponse implements ModelInterface, ArrayAccess
{
...
* @var string
*/
protected static $swaggerModelName = 'MachineDetailsResponse';
