...
/**
 * BrandDefinition Model
 *
 * @category Class
 * @package  Fozzy\WinVPS\Api
 * @author   Fozzy Inc.
 */
class BrandDefinition implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BrandDefinition';
...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param int $id Brand primary ID. Used on machine creation
     *
     * @return $this
     */
