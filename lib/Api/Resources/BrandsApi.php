...
class BrandsApi extends Resource
{
     ...
     * @return \Fozzy\WinVPS\Api\Models\Brand[]
     */
     ...
     * @throws \Fozzy\WinVPS\Api\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Fozzy\WinVPS\Api\Models\Brand[], HTTP status code, HTTP response headers (array of strings)
     */
    public function brandsGetWithHttpInfo()
    {
        $returnType = '\Fozzy\WinVPS\Api\Models\Brand[]';
     ...
     */
    public function brandsGetAsync()
    {
        return $this->brandsGetAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function brandsGetRequest()
    {
